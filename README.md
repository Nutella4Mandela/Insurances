...
<br/>
(Insurance name)_(Number signifies the conditions of the insurance(Accept/Not Accept/OON Benefits/etc))_(Number signifies if they need a referral)_(Number signifies the Doctor(s))_(Description)
